#!/usr/bin/env python3
"""Run enriched Gowalla friendship prediction: 5 models x 5 levels (with venue categories)."""
...
def main():
    ...
    print(f"Loaded {len(test_cases)} filtered test cases (both users ≥50% known categories)")
    ...
    print("\nDone. Run: python3 scripts/gowalla_enrich_analyze.py")
